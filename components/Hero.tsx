...
const Hero: React.FC = () => {
  return (
    <section id="inicio" className="relative w-full min-h-[90vh] flex items-center pt-24 bg-brand-cream overflow-hidden">
      {/* Decorative Circles */}
      ...
      <div className="container mx-auto px-6 grid md:grid-cols-2 gap-12 items-center relative z-10">
        ...
        <div className="relative group">
          ...
          />
          {/* Float Badge */}
          <div className="absolute -bottom-6 -right-6 md:right-10 bg-white p-4 rounded-2xl shadow-xl animate-bounce duration-[3000ms]">
